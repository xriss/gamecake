...
The bin dir is a testbed containing pre-built binaries and lua scripts and data. This is the final output and is then shared with other, lua only  projects or build tools.
...
apt.sh may manage to do this for you if you are lucky...
...
If you are very very lucky then the nix and win binaries found under bin will simply work and there wll be no need to build anything.
