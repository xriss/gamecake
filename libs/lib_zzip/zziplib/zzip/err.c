...
static struct errlistentry {
    ...
    {ZZIP_DIR_OPEN, "Failed to open zip-file"},
    {ZZIP_DIR_STAT, "Failed to fstat zip-file"},
    {ZZIP_DIR_SEEK, "Failed to lseek zip-file"},
    {ZZIP_DIR_READ, "Failed to read zip-file"},
    {ZZIP_DIR_TOO_SHORT, "central directory too short in zip-file"},
    {ZZIP_DIR_EDH_MISSING, "central directory not found in zip-file"},
    {ZZIP_DIRSIZE, "Directory size too big..."},
    {ZZIP_ENOENT, "No such file found in zip-file"},
