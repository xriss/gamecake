...
wiretasks.gist_baseurl="https://api.github.com"
...
--[[#lua.wiretasks.gist_parse_iso8601

	seconds = wiretasks.gist_parse_iso8601(text)

Parse a string in iso8601 format into a linux time ( seconds since 1970 )

]]
wiretasks.gist_parse_iso8601=function(str)
...
set in wiretasks.gist_baseurl and can also be changed globally there.
...
which is set in wiretasks.gist_baseurl and can also be changed globally 
there.
