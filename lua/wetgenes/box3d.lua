...
A lua binding to the box3d physics library see https://box3d.org/ for 
more documentation on how box3d works.
...
box3d.world_functions={is="world"}
box3d.world_metatable={__index=box3d.world_functions}
...
box3d.joint_functions={is="joint"}
box3d.joint_metatable={__index=box3d.joint_functions}
...
def contains the values that you can set in a b3WorldDef and must be a 
...
box3d.world=function(def)
	local world={}
	setmetatable(world,box3d.world_metatable)
...
box3d.world_functions.destroy=function(world)
...
box3d.world_functions.info=function(world)
...
box3d.world_functions.get=function(world)
...
box3d.world_functions.set=function(world,vars)
...
box3d.world_functions.step=function(world,seconds,steps)
...
box3d.world_functions.prepare_events=function(world,events)
...
box3d.world_functions.body_events=function(world,events)
...
box3d.world_functions.sensor_events=function(world,events)
...
box3d.world_functions.contact_events=function(world,events)
...
is B3_MAX_POLYGON_VERTICES (8) To cast a circle shape, just use a 
...
box3d.world_functions.cast=function(world,ray)
...
box3d.world_functions.overlap=function(world,shape)
...
box3d.world_functions.fill=function(world,def,name)
...
box3d.world_functions.fills=function(world,def,...)
...
box3d.world_functions.defaults=function(world,name,def)
...
box3d.world_functions.bits=function(world,name,bits)
...
def contains the values that you can set in a b3BodyDef and must be a 
unique table as it will be retained.
...
box3d.world_functions.body=function(world,def)
	local body={}
	setmetatable(body,box3d.body_metatable)
...
box3d.body_functions.destroy=function(body)
...
box3d.body_functions.info=function(body)
...
box3d.body_functions.get=function(body)
...
box3d.body_functions.set=function(body,vars)
...
box3d.body_functions.type=function(body,btype)
...
box3d.body_functions.awake=function(body,b)
...
box3d.body_functions.transform=function(body,x,y,r)
...
box3d.body_functions.velocity=function(body,x,y,r)
...
box3d.body_functions.force=function(body,x,y,r)
...
box3d.body_functions.acceleration=function(body,x,y,r)
...
box3d.body_functions.mass=function(body,mass,ri,x,y)
...
do
	...
	box3d.body_functions.convert=function(body,x,y,str)
...
box3d.body_functions.aabb=function(body)
...
def contains the values that you can set in a b3ShapeDef and must be a 
unique table as it will be retained.
...
set in a b3Polygon using b3MakeOffsetRoundedBox
...
box3d.body_functions.shape=function(body,def)
	local shape={}
	setmetatable(shape,box3d.shape_metatable)
...
box3d.shape_functions.destroy=function(shape)
...
box3d.shape_functions.info=function(shape)
...
box3d.shape_functions.get=function(shape)
...
box3d.shape_functions.set=function(shape,vars)
...
box3d.shape_functions.convert=function(shape,x,y,conversion)
...
box3d.shape_functions.aabb=function(shape)
...
def contains the values that you can set in a b3jointDef and must be a 
unique table as it will be retained.
...
box3d.world_functions.joint=function(world,def)
	local joint={}
	setmetatable(joint,box3d.joint_metatable)
...
box3d.joint_functions.destroy=function(joint)
...
box3d.joint_functions.info=function(joint)
...
box3d.joint_functions.get=function(joint)
...
box3d.joint_functions.set=function(joint,vars)
