...
function wtreegist.item_refresh(treefile,item)
...
function wtreegist.item_toggle_dir(treefile,item)
	if item.expanded then
...
function wtreegist.item_empty_dir(treefile,item,recurse)
...
function wtreegist.item_fill_dir(treefile,item)
	treefile.master.request_layout=true
...
function wtreegist.item_sort(treefile,item)
...
function wtreegist.add_dir_item(treefile,path)
...
function wtreegist.add_file_item(treefile,path)
	treefile.master.request_layout=true
