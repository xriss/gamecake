...
uniform vec4  over_info; /* 0,1 over tile size eg 24x24 */
...
void main()
{
	...
	gl_Position = projection * modelview * vec4( pos.xy + round(projection_zxy*pos.z) , 0.0 , 1.0);
...
//gl_FragColor=vec4(fract(tc.xy),1,1);
